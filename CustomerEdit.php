...
$query = "UPDATE Customer SET FName = '$firstName', LName = '$lastName', Email = '$email', Address = '$address', City = '$city', Postcode = '$postcode', TotalPoints = '$totalPoints' WHERE FName = 'Jam'";
